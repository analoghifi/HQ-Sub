...
to get meaningful (= not too high) resistance values in this filter design we want to use 1µF capacitors.  
However, 1µF capacitors are generally not available in the KP film/foil version,  
at least not with a 1% tolerance and/or in suitable small dimensions for this small board.  
...
the PCB is prepared for using this big axial capacitors (10.5mm x 26.5mm) in upright position.  
